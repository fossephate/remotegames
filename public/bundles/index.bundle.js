...
/* harmony import */ var shared_components_general_Loading_jsx__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! shared/components/general/Loading.jsx */ "./src/shared/components/general/Loading.jsx");
...
/* harmony import */ var _reducers__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./reducers */ "./src/reducers/index.js");
/* harmony import */ var src_actions_settings_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! src/actions/settings.js */ "./src/actions/settings.js");
/* harmony import */ var src_actions_clientInfo_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! src/actions/clientInfo.js */ "./src/actions/clientInfo.js");
...
/* harmony import */ var src_sagas_account___WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! src/sagas/account/ */ "./src/sagas/account/index.js");
/* harmony import */ var src_sockets_account___WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! src/sockets/account/ */ "./src/sockets/account/index.js");
/* harmony import */ var socket_io_client__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! socket.io-client */ "./node_modules/socket.io-client/lib/index.js");
...
const About = Object(react__WEBPACK_IMPORTED_MODULE_0__["lazy"])(() => Promise.all(/*! import() */[__webpack_require__.e(14), __webpack_require__.e(21)]).then(__webpack_require__.bind(null, /*! src/About.jsx */ "./src/About.jsx")));
const FAQ = Object(react__WEBPACK_IMPORTED_MODULE_0__["lazy"])(() => Promise.all(/*! import() */[__webpack_require__.e(14), __webpack_require__.e(2), __webpack_require__.e(15)]).then(__webpack_require__.bind(null, /*! src/FAQ.jsx */ "./src/FAQ.jsx")));
const ToS = Object(react__WEBPACK_IMPORTED_MODULE_0__["lazy"])(() => Promise.all(/*! import() */[__webpack_require__.e(14), __webpack_require__.e(2), __webpack_require__.e(17)]).then(__webpack_require__.bind(null, /*! src/ToS.jsx */ "./src/ToS.jsx")));
const Privacy = Object(react__WEBPACK_IMPORTED_MODULE_0__["lazy"])(() => Promise.all(/*! import() */[__webpack_require__.e(14), __webpack_require__.e(2), __webpack_require__.e(16)]).then(__webpack_require__.bind(null, /*! src/Privacy.jsx */ "./src/Privacy.jsx")));
const Streams = Object(react__WEBPACK_IMPORTED_MODULE_0__["lazy"])(() => Promise.all(/*! import() */[__webpack_require__.e(14), __webpack_require__.e(2), __webpack_require__.e(5), __webpack_require__.e(4)]).then(__webpack_require__.bind(null, /*! src/Streams.jsx */ "./src/Streams.jsx")));
const Stream = Object(react__WEBPACK_IMPORTED_MODULE_0__["lazy"])(() => Promise.all(/*! import() */[__webpack_require__.e(14), __webpack_require__.e(2), __webpack_require__.e(1), __webpack_require__.e(3)]).then(__webpack_require__.bind(null, /*! src/Stream.jsx */ "./src/Stream.jsx"))); // redux:
...
const sagaMiddleware = Object(redux_saga__WEBPACK_IMPORTED_MODULE_14__["default"])();
let preloadedState = {
  // account: {
  //
  // },
...
function loadState() {
  ...
  localforage__WEBPACK_IMPORTED_MODULE_18___default.a.getItem("settings").then(value => {
    ...
    store.dispatch(Object(src_actions_settings_js__WEBPACK_IMPORTED_MODULE_12__["updateSettings"])({ ...settings
    })); // check if banned:

    localforage__WEBPACK_IMPORTED_MODULE_18___default.a.getItem("banned").then(value => {
      if (value) {
        store.dispatch(Object(src_actions_clientInfo_js__WEBPACK_IMPORTED_MODULE_13__["updateClientInfo"])({
          isBanned: true
        }));
        window.banned = true;
      } else {
...
loadState();
const store = Object(_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_10__["configureStore"])({
  reducer: _reducers__WEBPACK_IMPORTED_MODULE_11__["default"],
...
window.onbeforeunload = () => {
  ...
  localforage__WEBPACK_IMPORTED_MODULE_18___default.a.setItem("settings", JSON.stringify(store.getState().settings));
  return null;
};

let accountConnection = socket_io_client__WEBPACK_IMPORTED_MODULE_17___default()("https://remotegames.io", {
  path: "/8099/socket.io",
  transports: ["polling", "websocket", "xhr-polling", "jsonp-polling"]
}); // listen to events and dispatch actions:

Object(src_sockets_account___WEBPACK_IMPORTED_MODULE_16__["default"])(accountConnection, store.dispatch); // handle outgoing events & listen to actions:
// and maybe dispatch more actions:

sagaMiddleware.run(src_sagas_account___WEBPACK_IMPORTED_MODULE_15__["default"], {
...
class Index extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(props) {
    ...
    _defineProperty(this, "switchTheme", themeName => {
      let theme = {};
  ...
  render() {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_redux__WEBPACK_IMPORTED_MODULE_9__["Provider"], {
    ...
    }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(notistack__WEBPACK_IMPORTED_MODULE_7__["SnackbarProvider"], {
      maxSnack: 3
      ...
      fallback: react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(shared_components_general_Loading_jsx__WEBPACK_IMPORTED_MODULE_8__["default"], null)
    ...
    socket.emit("getAccountInfo", {
      ...
      if (data.success) {
        ...
        if (data.reason === "ACCOUNT_NOT_FOUND") {
          ...
          dispatch(Object(src_features_client_js__WEBPACK_IMPORTED_MODULE_0__["updateClient"])({
            authToken: null
          }));
        }
      }
