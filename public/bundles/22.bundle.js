...
/* harmony import */ var recompose__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! recompose */ "./node_modules/recompose/dist/Recompose.esm.js");
/* harmony import */ var src_libs_utils_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/libs/utils.js */ "./src/libs/utils.js");
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
const styles = theme => ({
  ...
  [src_libs_utils_js__WEBPACK_IMPORTED_MODULE_7__["device"].tablet]: {
    root: {}
  },
  [src_libs_utils_js__WEBPACK_IMPORTED_MODULE_7__["device"].laptop]: {
    root: {}
  },
  // root: {
  // 	display: "flex",
...
const styles = theme => ({
  ...
  [src_libs_utils_js__WEBPACK_IMPORTED_MODULE_7__["device"].mobile]: {
    root: {}
  },
  [src_libs_utils_js__WEBPACK_IMPORTED_MODULE_7__["device"].tablet]: {
    root: {}
