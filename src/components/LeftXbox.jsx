...
class LeftXbox extends PureComponent {
			...
			<div className={classes.root}>
				...
				<div className={classes.otherButtons}>
					...
					<div className={classNames(classes.button, classes.otherButtons, "zl")}>
						<div className={classNames(classes.trigger1, {[classes.highlighted]: (this.controller.buttons.zl)})}>LT</div>
...
export default withStyles(styles)(LeftXbox);
