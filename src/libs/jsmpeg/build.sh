...
# for some reason source ./emsdk_env.sh doesn't set this anymore:
# EMSCRIPTEN="/mnt/c/Users/fosse/Projects/emsdk/upstream/emscripten"
# EMSCRIPTEN="/home/fosse/emsdk/upstream/emscripten"
...
EMSCRIPTEN_LIB="/home/fosse/emsdk/fastcomp/emscripten/system/lib"
...
rm jsmpeg.wasm.js
echo "export const WASM_BINARY_INLINED='$(base64 jsmpeg.wasm | tr -d "\n")';" >> jsmpeg.wasm.js
